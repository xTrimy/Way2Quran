<div id="share_modal" class="fixed hidden flex side-paddings items-center justify-center w-full h-full bg-neutral-500 backdrop-blur-sm" style="z-index:99; --tw-bg-opacity:0.4">
    <div class="w-full max-w-xl bg-light-300 dark:bg-dark-500 shadow-xl py-4 dark:text-white rounded-lg">
        <div class="flex justify-between items-center mb-3 px-8">
            <p class="text-xl ">Share </p>
            <button id="share_modal_close">
                <i class="las la-times-circle text-2xl cursor-pointer text-neutral-500 dark:hover:text-white"></i>
            </button>
        </div>
        ...
        <div class="w-full flex">
            <input type="text" class="flex-grow px-8 py-4 dark:bg-neutral-500 dark:text-white rounded-l-lg " value="{{ urldecode( url()->current() ) }}" id="share_link">
            <button id="copy_share_link" class="bg-primary-500 text-white font-bold flex items-center px-4 rounded-r-lg relative">
